...
Ở bài viết trước về [Shopping Cart](e-commerce-backend), mình đã trình bày chi tiết về **Clean Architecture** và cách nó giúp tách biệt rõ ràng các tầng trong một ứng dụng Web. Trong dự án Trading Engine này, mình vẫn giữ nguyên tắc đó ở cấp độ crate, nhưng điểm nhấn kiến trúc lần này nằm ở một pattern hoàn toàn khác biệt: **LMAX Disruptor**.
